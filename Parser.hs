...
happyExpList = Happy_Data_Array.listArray (0,64) ([0,5632,0,5632,0,5634,0,0,0,2,0,0,0,0,0,0,0,0,0,24576,0,0,0,2,0,0,0,0,0,0,0,64,32768,131,0,0,0,0,0,2,0,0,0,8192,0,12,0,48,0,0,0,0,0,0,0,0,32768,131,0,268,32768,131,32768,131,32768,131,32768,131,0,0,0,48,0,48,0,0,0,0,0,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_calc","Programa","Comandos","Comando","Atrib","Decls","Decl","ListaId","Type","Exp","Expr","Term","Factor","LITInt","LITDouble","ID","OPAdd","OPSub","OPMul","OPDiv","OPAtrib","LPar","RPar","TInt","TDouble","TVoid","TString","PVirg","Virg","%eof"]
...
action_16 (15) = happyGoto action_24
...
action_28 (15) = happyGoto action_24
action_28 _ = happyFail (happyExpListPerState 28)

action_29 (19) = happyShift action_32
action_29 (20) = happyShift action_33
...
action_30 (24) = happyShift action_28
...
action_33 (14) = happyGoto action_35
action_33 (15) = happyGoto action_24
...
happyReduction_9 (HappyTerminal (Token.ID happy_var_3))
	_
...
happyReduction_10 (HappyTerminal (Token.ID happy_var_1))
	 =  HappyAbsSyn10
		 ([happy_var_1]
	)
...
happyReduction_21 (HappyTerminal (Token.LITInt happy_var_1))
	 =  HappyAbsSyn15
...
happyReduction_22 (HappyTerminal (Token.LITDouble happy_var_1))
	 =  HappyAbsSyn15
...
happyReduction_23 (HappyTerminal (Token.ID happy_var_1))
	 =  HappyAbsSyn15
...
happyNewToken action sts stk (tk:tks) =
	...
	case tk of {
	Token.LITInt happy_dollar_dollar -> cont 16;
	Token.LITDouble happy_dollar_dollar -> cont 17;
	Token.ID happy_dollar_dollar -> cont 18;
	Token.OPAdd -> cont 19;
	Token.OPSub -> cont 20;
	Token.OPMul -> cont 21;
	Token.OPDiv -> cont 22;
	Token.OPAtrib -> cont 23;
	Token.LPar -> cont 24;
	Token.RPar -> cont 25;
	Token.TInt -> cont 26;
	Token.TDouble -> cont 27;
	Token.TVoid -> cont 28;
	Token.TString -> cont 29;
	Token.PVirg -> cont 30;
	Token.Virg -> cont 31;
	_ -> happyError' ((tk:tks), [])
	}
