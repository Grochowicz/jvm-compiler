...
alex_table = Data.Array.listArray (0 :: Int, 2014)
  [ 0
  , 20
  , 20
  , 20
...
alex_check = Data.Array.listArray (0 :: Int, 2014)
  [ -1
  , 9
  , 10
  , 11
...
alex_action_0 = \s -> TInt
alex_action_1 = \s -> TDouble
alex_action_2 = \s -> TVoid
alex_action_3 = \s -> TString
alex_action_5 = \s -> ID s
alex_action_6 = \s -> LITInt (read s)
alex_action_7 = \s -> LITDouble (read s)
alex_action_8 = \s -> OPAtrib
alex_action_9 = \s -> OPAdd
alex_action_10 = \s -> OPSub
alex_action_11 = \s -> OPMul
alex_action_12 = \s -> OPDiv
alex_action_13 = \s -> LPar
alex_action_14 = \s -> RPar
alex_action_15 = \s -> PVirg
alex_action_16 = \s -> Virg
